#!/bin/bash
#SBATCH --job-name=spectral-finalize-merge
...
#SBATCH --output=/global/scratch/users/%u/spectral-similarities-by-peaks/logs/finalize_merge_%j.out
#SBATCH --error=/global/scratch/users/%u/spectral-similarities-by-peaks/logs/finalize_merge_%j.err
...
echo "Command:    target/release/spectral-similarities-by-peaks finalize-merge $*"

target/release/spectral-similarities-by-peaks finalize-merge "$@"
