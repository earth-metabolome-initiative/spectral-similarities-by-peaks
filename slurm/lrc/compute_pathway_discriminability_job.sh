#!/bin/bash
#SBATCH --job-name=spectral-pathway-discrim
...
#SBATCH --output=/global/scratch/users/%u/spectral-similarities-by-peaks/logs/pathway_discrim_%j.out
#SBATCH --error=/global/scratch/users/%u/spectral-similarities-by-peaks/logs/pathway_discrim_%j.err
...
echo "Command:    target/release/spectral-similarities-by-peaks compute-pathway-discriminability $*"
